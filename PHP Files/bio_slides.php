...
$title = "{$currentShow->getTitle()} Bios Slideshow";
...
foreach($cast as $c) {
	...
	$castBios .= "
		<section id='person_{$c->id}' data-person='{$c->lastName}_{$c->firstName}' class='cast-bio {$currentShow->getAbbr()}'>
			<div>
...
<?=$header;?>
	<section class='main'>
		<h3>Cast Bios</h3>
		<h4>Read more on your phone! &nbsp; <a href='http://www.iptheater.com/bios'>www.IPTheater.com/bios</a></h4>
		<?=$castBios;?>
	</section>
<?=$footer;?>
