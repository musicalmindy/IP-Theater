...
$questions = array(
	...
	"2. Was this your first time working with Immeasurable Productions' musical?",
	...
	"6. How likely are you to return for another Immeasurable Productions summer camp musical?",
...
?>
		<p>Exclusively for the cast and parents of cast members in <em><?=$currentShow->getTitle();?></em> Summer <?= date('Y'); ?></p>
				...
				<table>
					<tr class='question'><td><?=$questions[1];?></td></tr>
						<tr class='answer radio'><td>
							<input type='radio' name='age' required id='age_12' value='12 &amp; under'><label for='age_12'>12 &amp; under</label><br>
							<input type='radio' name='age' required id='age_13' value='13-14'><label for='age_13'>13-14</label><br>
							<input type='radio' name='age' required id='age_15' value='15-17'><label for='age_15'>15-17</label><br>
							<!-- <input type='radio' name='age' required id='age_18' value='18+'><label for='age_18'>18+</label><br> -->
							<input type='radio' name='age' required id='age_parent' value='Parent'><label for='age_parent'>Parent</label></td></tr>
					<tr class='question'><td><?=$questions[2];?></td></tr>
						<tr class='answer radio'><td>
							<input type='radio' name='first' required id='first_y' value='Yes'><label for='first_y'>Yes</label><br>
							<input type='radio' name='first' required id='first_n' value='No'><label for='first_n'>No</label></td></tr>
					<tr class='question'><td><?=$questions[3];?></td></tr>
						<tr class='answer radio'><td>
							<input type='radio' name='impression' required id='impression_loved' value='Totally loved it!  So glad I did it!'><label for='impression_loved'>Totally loved it!  So glad I did it!</label><br>
							<input type='radio' name='impression' required id='impression_enjoyed' value='I enjoyed it. It was a good experience.'><label for='impression_enjoyed'>I enjoyed it. It was a good experience.</label><br>
							<input type='radio' name='impression' required id='impression_okay' value='It was okay.'><label for='impression_okay'>It was okay.</label><br>
							<input type='radio' name='impression' required id='impression_else' value="Wish I would've done something else for summer break."><label for='impression_else'>Wish I would've done something else for summer break.</label><br>
							<input type='radio' name='impression' required id='impression_other' value='Other'><label for='impression_other'>Other:</label> <input type='text' name='imp_other' id='imp_other' onchange='document.getElementById("impression_other").checked=true'></td></tr>
					...
					<tr class='question'><td><?=$questions[6];?></td></tr>
						<tr class='answer radio'><td>
							<input type='radio' name='involved' required id='involved_a' value='Absolutely!'><label for='involved_a'>Absolutely!</label><br>
							<input type='radio' name='involved' required id='involved_vl' value='Very likely.'><label for='involved_vl'>Very likely.</label><br>
							<input type='radio' name='involved' required id='involved_p' value='Possibly.'><label for='involved_p'>Possibly.</label><br>
							<input type='radio' name='involved' required id='involved_n' value='Not very likely.'><label for='involved_n'>Not very likely.</label><br>
							<input type='radio' name='involved' required id='involved_d' value='Depends on the musical.'><label for='involved_d'>Depends on the musical.</label></td></tr>
